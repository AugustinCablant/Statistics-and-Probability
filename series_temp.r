...
#### Q1 ####
path <- "/Users/augustincablant/Desktop/Cours/series_temp"
setwd(path) #definit l'espace de travail (working directory ou "wd")
getwd() #affiche le wd
list.files() #liste les elements du wd

datafile <- "TD4.csv" #definit le fichier de donnees
...
#pour vérifier la stationarité : regarder s'il y a une tendance / regarder si saisonnalité / regarder variation de la variance 
...
#### Q8 ####
datafile <- "TD4_2.csv" #definit le fichier de donnees
